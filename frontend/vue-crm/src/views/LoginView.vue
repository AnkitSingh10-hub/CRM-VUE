                ...
                <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                    <form @submit.prevent="submit">
                        ...
                        <div class="form-outline mb-4">
                            <input v-model="data.username" type="text" id="form3Example2"
                        ...
                        <!-- Email input -->
                        <div class="form-outline mb-4">
                            <input v-model="data.email" type="email" id="form3Example3" class="form-control form-control-lg"
                        ...
                        <div class="form-outline mb-3">
                            <input v-model="data.password" type="password" id="form3Example4"
    ...
    setup() {
        ...
        const submit = async () => {
            try {
                ...
                console.log(responseData, 'Successfully LOGGED IN');
            } catch (error) {
